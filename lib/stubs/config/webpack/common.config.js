...
var src_path = path.join(__dirname, '..', '..', 'app', 'assets', 'javascripts');
var build_path = path.join(__dirname, '..', '..', 'public', 'assets', 'javascripts');
var asset_map_path = path.join(__dirname, '..', '..', 'public', 'assets', 'asset_map.json');
